...
```{r paths}
path.harp <- "/gpfs/data/abl/home/cather01/rugglesLab/HARP/"
path.pace <- "/gpfs/data/abl/home/cather01/rugglesLab/PACE/"
...
write.csv(gene.out.df.harp, paste0(path.harp, "DATA/shared_genes_post-process.csv"), row.names=FALSE)
write.csv(gene.out.df.pace, paste0(path.pace, "DATA/shared_genes_post-process.csv"), row.names=FALSE)
